# 📈 ENPH (Enphase Energy, Inc.) ML Backtest Report
...
- **Sector**: Technology
- **Industry**: Solar
- **Trailing P/E**: 65.78218
- **Forward P/E**: 27.45829
- **Beta**: 1.254
...
|------------------|-----------------|---------|
| **Total Return** | -0.28% | ผลตอบแทนรวมทั้งหมดตลอดช่วงเวลาที่ทดสอบ |
| **CAGR** | -24.59% | อัตราผลตอบแทนทบต้นต่อปี (หากลงทุนครบปีจะได้กำไรเท่านี้) |
| **Sharpe Ratio** | -1.02 | ความคุ้มค่าของผลตอบแทนเมื่อเทียบกับความเสี่ยง (ควร > 1.0) |
| **Max Drawdown** | -0.41% | จุดที่พอร์ตขาดทุนหนักที่สุดจากจุดสูงสุด (วัดความเสี่ยง) |
...
| **Final Capital** | $9,971.81 | เงินทุนสุทธิหลังจบการจำลอง |

## 📉 Charts
![Backtest Chart](./ENPH_chart.png)
...
|------------|-----------|------|---------------|-------------|------|-----|------|-------------|-----------|--------------------|---------|----------|-------------|
| 2026-06-02 10:51 | 2026-06-02 12:28 | **LONG** | 29.6692 | $67.41 | 32.56% | 130.24% | - | 🎯 $155.20 | 🛡️ $1.57 | $66.46 (-1.41%) | **-$28.19** | 0.61 | End of Data |
